...
# elign_team
CUDA_VISIBLE_DEVICES=8 python train_multi_sacd.py --task simple_tag_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_team --epoch 50 --save-models --benchmark  --logdir log/simple_tag_elign_team
CUDA_VISIBLE_DEVICES=9 python train_multi_sacd_cond.py --task simple_tag_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_team --epoch 50 --save-models --benchmark  --logdir log/simple_tag_cond_elign_team
# elign_adv
CUDA_VISIBLE_DEVICES=0 python train_multi_sacd.py --task simple_tag_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_adv --epoch 50 --save-models --benchmark  --logdir log/simple_tag_elign_adv
CUDA_VISIBLE_DEVICES=1 python train_multi_sacd_cond.py --task simple_tag_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_adv --epoch 50 --save-models --benchmark  --logdir log/simple_tag_cond_elign_adv

# Scenario 2
# Keep-away (4v4) (simple_push_in)
# elign_team
CUDA_VISIBLE_DEVICES=2 python train_multi_sacd.py --task simple_push_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_team --epoch 50 --save-models --benchmark  --logdir log/simple_push_elign_team
CUDA_VISIBLE_DEVICES=3 python train_multi_sacd_cond.py --task simple_push_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_team --epoch 50 --save-models --benchmark  --logdir log/simple_push_cond_elign_team
# elign_adv
CUDA_VISIBLE_DEVICES=4 python train_multi_sacd.py --task simple_push_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_adv --epoch 50 --save-models --benchmark  --logdir log/simple_push_elign_adv
CUDA_VISIBLE_DEVICES=5 python train_multi_sacd_cond.py --task simple_push_in --num-good-agents 4 --num-adversaries 4 --obs-radius 0.5 --intr-rew elign_adv --epoch 50 --save-models --benchmark  --logdir log/simple_push_cond_elign_adv
